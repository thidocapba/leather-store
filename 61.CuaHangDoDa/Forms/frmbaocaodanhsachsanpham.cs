...
{
    public partial class frmbaocaodanhsachsanpham : Form
    {
        public frmbaocaodanhsachsanpham()
        {
            InitializeComponent();
        }
        DataTable tblds;
        ...
        private void frmbaocaodanhsachsanpham_Load(object sender, EventArgs e)
        {
        ...
        {           
            ...
            txttongtienbaocao.Text = tongtienbaocao().ToString();
        }
        ...
        private void frmbaocaodanhsachsanpham_FormClosing(object sender, FormClosingEventArgs e)
        {
            ResetValues();
        }
