...
namespace _61.CuaHangDoDa.Forms
{
    public partial class frmBCDoanhthu : Form
    {
        ...
        {
            string sql;
            sql = "SELECT a.manhanvien, a.tennhanvien, b.mahoadonban, b.ngayban, b.tongtien FROM tblnhanvien AS a JOIN tblhoadonban AS b ON a.manhanvien = b.manhanvien WHERE a.manhanvien = N'" + cboManhanvien.Text + "' AND month(b.ngayban) = N'" + txtThang.Text + "'";
            ...
            else if (Convert.ToInt32(txtThang.Text) > 12 || Convert.ToInt32(txtThang.Text) < 1)
            {
                MessageBox.Show("Tháng k hợp lệ, vui lòng nhập lại !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtThang.Focus();
                return;
            }
            ...
            else
            {
                ...
                Load_DataGridView();
                sql = "SELECT sum(tongtien) FROM tblhoadonban WHERE manhanvien = N'" + cboManhanvien.Text + "' AND month(ngayban) = N'" + txtThang.Text + "'";
                string s = Functions.GetFieldValues(sql);
                txtDoanhthu.Text = s;
                lblBangchu.Text = "Bằng chữ: " + Functions.ChuyenSoSangChu(s);
            }
            btnHienthi.Enabled = false;
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT a.manhanvien, a.tennhanvien, b.mahoadonban, b.ngayban, b.tongtien FROM tblnhanvien a JOIN tblhoadonban b ON a.manhanvien = b.manhanvien WHERE a.manhanvien = N'" + cboManhanvien.Text + "' and month(b.ngayban) = '" + txtThang.Text + "'";

            tblInbcdt = Functions.GetDataToTable(sql);
            ...
            exRange.Value2 = "Doanh thu: " + txtDoanhthu.Text;
            exRange = exSheet.Cells[3][hang + 11];
            exRange.Range["A1:F1"].MergeCells = true;
            exRange.Range["A1:F1"].Font.Bold = true;
            exRange.Range["A1:F1"].Font.Italic = true;
            exRange.Range["A1:F1"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignRight;
            exRange.Range["A1:F1"].Value = "Bằng chữ: " + Functions.ChuyenSoSangChu(txtDoanhthu.Text);
        ...
        private void frmBCDoanhthu_FormClosing(object sender, FormClosingEventArgs e)
        {
            ResetValues();
        }
