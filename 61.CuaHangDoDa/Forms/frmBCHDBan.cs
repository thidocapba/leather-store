...
{
    public partial class frmBCHDBan : Form
    {
        public frmBCHDBan()
        {
            InitializeComponent();
        ...
        private void btntimkiem_Click(object sender, EventArgs e)
        {
            ...
            if (rdobtn1.Checked == true)
            {
                ...
                tblbanhang = Class.Functions.GetDataToTable(sql);


                if (tblbanhang.Rows.Count == 0)
                {
                ...
                {
                    MessageBox.Show("Có " + tblbanhang.Rows.Count + " bản ghi thỏa mãn điều kiện!!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    dgnhaphang.DataSource = tblbanhang;
                    Load_dghoadonnhap();
