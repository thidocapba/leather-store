...
namespace _61.CuaHangDoDa.Forms
{
    public partial class frmtimkiemhoadonnhap : Form
    {
        ...
        private void btntimkiem_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(functions.GetFieldValues(sql));
            ...
            if (tblhd.Rows.Count == 0)
            {
                ...
                MessageBox.Show("Có " + tblhd.Rows.Count + " bản ghi thỏa mãn điều kiện!!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
